      ...
      <div class="row" id="change">
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3 class="attendance">Click Once</h3>
                  <p>Attendance</p>
              </div>
              <div class="icon">
                <i class="fa-solid fa-clipboard-user"></i>
              </div>
              <a href="attendance.php"  class="small-box-footer clickable">Record Attendance<i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
      </div>
    ...
    function show(){
      $.ajax({
        ...
        success:function(data){
          $(".total_subject").text(data.total_subject);
