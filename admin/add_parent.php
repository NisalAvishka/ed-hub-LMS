...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="col-md-12">
          <h3 class="text-center my-3">Register Parents</h3>
          <form method="post" enctype="multipart/form-data" id="parents_reg">
            <div class="row d-flex justify-content-center">
            <div class="prt-result"></div>
            </div>
            ...
            <div class="row d-flex justify-content-center">
              <div class="col">
                ...
                <input type="text" name="chfname" class="form-control" placeholder="Enter Firstname of Child" autocomplete="off">
              </div>

              <div class="col">
                <label>Child's Last Name</label>
                <input type="text" name="chlname" class="form-control" placeholder="Enter Lastname of Child" autocomplete="off">
              </div>
            ...
            <div class="row d-flex justify-content-center">
              <div class="col-md-4">
                <input type="submit" name="registerprt" class=" btn btn-success my-3 col-md-4" value="Register Parent">
              </div>
            </div> 
          </form>
        </div>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $("#parents_reg").on("submit",function(e){
      e.preventDefault();

      $.ajax({
        url: "ajax/parent_reg.php",
        method: "POST",
